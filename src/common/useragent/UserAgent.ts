 ...
 * @return {boolean}
 */
function compare(name: string, version: string, query: string, normalizer?: (range: string) => string): boolean {
...
export const UserAgent = {
     ...
     * @return {boolean}
     */
    isBrowser: memoizeStringOnly((query: string): boolean => {
        return compare(
     ...
     * @return {boolean}
     */
    isBrowserArchitecture: memoizeStringOnly((query: string): boolean => {
        return compare(
     ...
     * @return {boolean}
     */
    isDevice: memoizeStringOnly((query: string): boolean => {
     ...
     * @return {boolean}
     */
    isEngine: memoizeStringOnly((query: string): boolean => {
        return compare(
     ...
     * @return {boolean}
     */
    isPlatform: memoizeStringOnly((query: string): boolean => {
        return compare(
     ...
     * @return {boolean}
     */
    isPlatformArchitecture: memoizeStringOnly((query: string): boolean => {
        return compare(
