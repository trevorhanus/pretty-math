import { insertSuperscript, insertFraction } from 'pretty-math/handlers/handleTextareaChange';
import {
    Editor,
    LibraryEntryConfig,
    LibraryEntry,
...
const algebra: LibraryEntryConfig[] = [
    ...
    {
        keywords: ['power', 'tothe', 'superscript'],
        category: 'Algebra',
        description: 'Take a number to the power',
        preview: {
            root: {
                type: 'root:math',
                children: {
